...
{
if(stat.startsWith("print ")) //checks for print statment
{
...
System.out.print(varValue.get(varName.indexOf(varCall))+" ");}
}
...
varName.add(stat.substring(stat.indexOf(" ")+1,stat.indexOf("=")).trim()); //read variable name store the variable name alone in list variable
...
{
    varValue.add(Value.substring(1, Value.length() - 1));
}
